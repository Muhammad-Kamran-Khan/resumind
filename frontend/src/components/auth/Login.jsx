...
function LoginForm() {
  const { loginUser, userState, handlerUserInput, user, authChecked, loading } = useUser();
    ...
    >
      <div className="relative z-10">
        ...
        <div className="mt-4 flex justify-end">
          <Link
            to="/forgot-password"
            className="font-semibold text-green-500 text-sm hover:text-green-600 transition-colors"
          >
            Forgot password?
          </Link>
        </div>
